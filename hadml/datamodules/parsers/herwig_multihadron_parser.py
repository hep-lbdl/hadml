...
****************************************************************************************************
from hadml.datamodules.parsers.herwig_multihadron_parser import Parser as HerwigMultihadronParser

parser = HerwigMultihadronParser(
...
class Parser():  
    ...
    def parse_data(self):
        ...
        and saving processed files as self.proccesed_filename. """

        # Looking for an existing processed data file
        if os.path.exists(self.processed_filepath):
            print("Found processed data in:", self.processed_filepath)
            return 
    ...
    def _create_pids_to_idx_dict(self, debug=False):
        ...
        print(f"The PID-to-MostCommonID map has been successfully saved in {self.pids_to_idx_path}.")
